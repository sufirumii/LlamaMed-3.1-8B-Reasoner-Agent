"""Fine-tuning script for LlamaMed-3.1-8B-Reasoner.

Trains unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit on the first 10,000
samples of lingshu-medical-mllm/ReasonMed via QLoRA (4-bit, rank 16).
Written for a single-GPU Kaggle/Colab-style environment (see the
CUDA_VISIBLE_DEVICES / memory settings below). See requirements-finetune.txt
for the exact install commands this script expects.
"""
